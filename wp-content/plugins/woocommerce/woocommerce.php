<?php
/**
 * Plugin Name: WooCommerce [MODIFIED]
 * Plugin URI: https://woocommerce.com/
 * Description: An eCommerce toolkit that helps you sell anything. Beautifully. [MODIFIED] Updates disabled due to crash with 4.9.1
 * Version: 9999.4.8.0
 * Author: Automattic [MODIFIED]
