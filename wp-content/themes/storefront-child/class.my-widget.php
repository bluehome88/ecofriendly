...
//require_once '/wp-content/plugins';
...
/**
 * HFE Cart_Dropdown Widget
 *
 * @since 1.4.0
 */
class Cart_Dropdown extends Widget_Base {
	...
	public function get_title() {
		return __( 'Cart Dropdown', 'header-footer-elementor' );
	}
